...
@section('content_header')
    ...
    <a href="{{ route('products.categories.available', $product->id) }}" class="btn btn-dark"><i class="fa fa-plus"></i></a>
                ...
                <tbody>
                    @foreach ($categories as $category)
                        <tr>
                            ...
                            <td style="width=10px;">
                                <a href="{{ route('products.category.detach', [$product->id, $category->id]) }}" class="btn btn-danger"><i class="fas fa-minus"></i></a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
