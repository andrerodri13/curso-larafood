...
@section('content_header')
    ...
    <h1>Produtos <a href="{{ route('products.create') }}" class="btn btn-dark"><i class="fa fa-plus"></i></a></h1>
@stop
                    ...
                    @foreach ($products as $product)
                        <tr>
                            ...
                            <td style="width:10px;">
                                ...
                                <a href="{{ route('products.edit', $product->id) }}"  class="btn btn-info"><i class="fas fa-pen-alt"></i></a>
